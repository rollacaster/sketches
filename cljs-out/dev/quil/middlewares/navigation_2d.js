...
return cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([initial_state,p1__14670_SHARP_], 0));
});})(initial_state))
);
});
/**
...
var nav_2d_14671 = cljs.core.cst$kw$navigation_DASH_2d.cljs$core$IFn$_invoke$arity$1(state);
var zoom_14672 = cljs.core.cst$kw$zoom.cljs$core$IFn$_invoke$arity$1(nav_2d_14671);
var pos_14673 = cljs.core.cst$kw$position.cljs$core$IFn$_invoke$arity$1(nav_2d_14671);
quil.core.scale.cljs$core$IFn$_invoke$arity$1(zoom_14672);

var tr__14574__auto___14674 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(((quil.core.width() / (2)) / zoom_14672) - cljs.core.first(pos_14673)),(((quil.core.height() / (2)) / zoom_14672) - cljs.core.second(pos_14673))], null);
quil.core.push_matrix();

try{quil.core.translate.cljs$core$IFn$_invoke$arity$1(tr__14574__auto___14674);
...
var G__14675 = quil.middlewares.navigation_2d.mouse_dragged(state,event);
var G__14676 = event;
return (user_mouse_dragged.cljs$core$IFn$_invoke$arity$2 ? user_mouse_dragged.cljs$core$IFn$_invoke$arity$2(G__14675,G__14676) : user_mouse_dragged.call(null,G__14675,G__14676));
...
return (function (state,event){
var G__14677 = quil.middlewares.navigation_2d.mouse_wheel(state,event);
var G__14678 = event;
return (user_mouse_wheel.cljs$core$IFn$_invoke$arity$2 ? user_mouse_wheel.cljs$core$IFn$_invoke$arity$2(G__14677,G__14678) : user_mouse_wheel.call(null,G__14677,G__14678));
});})(user_settings,user_draw,user_mouse_dragged,user_mouse_wheel,setup))
], 0));
});
