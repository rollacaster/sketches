...
var G__15881 = cljs.core.first(element_str);
switch (G__15881) {
case "?":
arr.push((1));
...
var G__15883 = cljs.core.next(items);
items = G__15883;
continue;
} else {
return null;
...
var G__15884 = cljs.core.next(items);
items = G__15884;
continue;
} else {
return null;
...
while(true){
if(items){
if(cljs.core.truth_((function (){var G__15886 = cljs.core.first(items);
return (is_valid_QMARK_.cljs$core$IFn$_invoke$arity$1 ? is_valid_QMARK_.cljs$core$IFn$_invoke$arity$1(G__15886) : is_valid_QMARK_.call(null,G__15886));
})())){
var G__15887 = cljs.core.next(cljs.core.next(items));
items = G__15887;
continue;
} else {
return true;
...
switch (G__15890) {
case (0):
if(cljs.core.truth_(oops.schema.has_invalid_path_access_mode_QMARK_(path,((function (G__15890){
return (function (p1__15888_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__15888_SHARP_,(2));
});})(G__15890))
))){
...
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__15889_SHARP_,(1));
});})(G__15890))
))){
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__15890)].join('')));
