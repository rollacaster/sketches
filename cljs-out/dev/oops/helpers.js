...
var and__3938__auto____$1 = cljs.core.not(oops.helpers.is_prototype_QMARK_(f));
...
var G__15613 = cljs.core.next(items);
items = G__15613;
continue;
} else {
return arr;
...
var x15614 = error;
x15614.cljs$core$IPrintWithWriter$ = cljs.core.PROTOCOL_SENTINEL;

x15614.cljs$core$IPrintWithWriter$_pr_writer$arity$3 = ((function (x15614){
...
var G__15615 = Object.getPrototypeOf(o);
o = G__15615;
continue;
} else {
...
var or__3949__auto__ = (cljs.core.truth_(wrap_QMARK_)?(function (){var temp__5739__auto__ = (goog.global["devtools"]);
