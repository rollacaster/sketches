(ns sketches.core
  (:require [quil.core :as q]
            ...
            [sketches.own-sketches.fire-ball :as fb]
            [sketches.own-sketches.fire-texture :as ft]
            [sketches.own-sketches.flowers :as flo]
            [sketches.own-sketches.heart-of-clojure :as hc]
            [sketches.own-sketches.inferno :as i]
            [sketches.own-sketches.noise-colors :as noc]
            [sketches.own-sketches.particle-party :as pp]
            [sketches.own-sketches.rainbow-circles :as rc]
            [sketches.own-sketches.reverse-roots :as rr]
            [sketches.own-sketches.rotating-angles :as ra]))
